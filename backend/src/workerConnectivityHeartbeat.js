 ...
 * - WORKER_LOCAL_URL : depuis le VPS, avec tunnel SSH -R souvent http://127.0.0.1:7410
 *   (valeur de SSH_RPORT dans le bundle worker, défaut 7410 ; l’API Node sur le VPS appelle ce port local).
 *
